...
namespace LearnCoreWehAppEF.Controllers
{
    public class MoviesController : Controller
    {
        private readonly MoviewDBContext _context;

        public MoviesController(MoviewDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Movie != null ? 
                          ...
                          Problem("Entity set 'MoviewDBContext.Movie'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MoviewDBContext.Movie'  is null.");
            }
            var movies = await _context.Movie.FindAsync(id);
            if (movies != null)
            {
